...
public class Auctions {
    ...
    /**
     * Table containing tell counts for players to ignore players who make too many bids per auction.
     */
    ...
    /**
     * Sends a tell to the given player name with a list of all people who have won items.
     * 
